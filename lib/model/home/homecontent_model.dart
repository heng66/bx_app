class HomeContentModel {
  ...
  HomeContentModel({this.code, this.message, this.data});

  HomeContentModel.fromJson(Map<String, dynamic> json) {
    code = json['code'];
    message = json['message'];
    data = json['data'] != null ? new HomeContentData.fromJson(json['data']) : null;
  }
...
class HomeContentData {
  ...
  HomeContentData.fromJson(Map<String, dynamic> json) {
    if (json['slides'] != null) {
