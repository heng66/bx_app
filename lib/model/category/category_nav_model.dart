...
class CategoryNavModel {
  String code;
  String message;
  List<CategoryNavData> data;

  CategoryNavModel({this.code, this.message, this.data});

  CategoryNavModel.fromJson(Map<String, dynamic> json) {
    code = json['code'];
    message = json['message'];
    if (json['data'] != null) {
      data = new List<CategoryNavData>();
      json['data'].forEach((v) {
        data.add(new CategoryNavData.fromJson(v));
      });
    }
  }
...
class CategoryNavData {
  ...
  CategoryNavData.fromJson(Map<String, dynamic> json) {
